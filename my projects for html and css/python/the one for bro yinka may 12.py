#for creativity I added some emojis and a word at the last sentence 

import random

# Define a list of words to be guessed
words = ["Youtube", "favour", "alma", "Indonesia", "motorcycle"]
...
while True:
    ...
    # If the guess is incorrect, update the hint
        ...
        print('This game was made for fun feel free to enjoy the game🎉🎉🎉.')
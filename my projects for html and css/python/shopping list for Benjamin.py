#for creativity i added my name at the end of the program.
# this is a program that calcates the price, and asks for the list 
...
while prices != 5 :
    ...
    if choice == "1":
        ...
        print("I hope you love our program.")
        break
    else:
        print("Invalid choice. Please try again.")
        
       ��������)
print("this program is created by benjamin...")         

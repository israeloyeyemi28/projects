...
# import random means out of any of those words, pick one and I added emojis.
print("😂🎉🤣👋👋This game was created for fun by Israel.")

import random

# Define a list of words to be guessed
words = ["jamaica","spendrite","messi","johncena","burnaboy" ,"israel", "mosiah", "nigeria", "insect"]
